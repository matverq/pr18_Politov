...
class CrimeFragment : Fragment() {
    ...
    private lateinit var dateButton: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton
    ...
    override fun onCreateView(
        ...
        dateButton = view.findViewById(R.id.crime_date) as com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton
        solvedCheckBox=view.findViewById(R.id.crime_solved) as CheckBox
        selectLanguageCheckBox= view.findViewById(R.id.select_language_checkbox) as CheckBox
        dateButton.apply {
